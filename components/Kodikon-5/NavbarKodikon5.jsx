...
const NavbarKodikon5 = () => {
    ...
    return (
        <>
            <nav
                className={`sticky top-0 left-0 right-0 w-full z-50 backdrop-blur  duration-200 border-b-2  ${isIntersecting
                    ...
                    <div>
                        <div className="flex items-center justify-between md:py-5 md:block">
                            ...
                            <div className="md:hidden flex flex-row items-center justify-center w-fit space-x-5">
                                //TODO
                                <Link href='https://vision.hack2skill.com/event/kodikon5/registration' target='_blank'>
                        ...
                        >
                            <ul className="items-center justify-center space-y-8 md:flex md:space-x-3 lg:space-x-6 md:space-y-0">
                                <li className="text-white text-xs lg:text-[16px]">
                                    <Link href="/kodikon-5/#about" onClick={() => setNavbar(false)}>About</Link>
                                </li>
                                <li className="text-white text-xs lg:text-[16px]">
                                    <Link href="/kodikon-5/#theme" onClick={() => setNavbar(false)}>Themes</Link>
                                </li>
                                <li className="text-white text-xs lg:text-[16px]">
                                    <Link href="/kodikon-5/#timeline" onClick={() => setNavbar(false)}>Timeline</Link>
                                </li>
                                <li className="text-white text-xs lg:text-[16px]">
                                    <Link href="/kodikon-5/#sponsor" onClick={() => setNavbar(false)}>Sponsors</Link>
                                </li>
                                <li className="text-white text-xs lg:text-[16px]">
                                    <Link href="/kodikon-5/#faq" onClick={() => setNavbar(false)}>FAQ</Link>
                                </li>
                                <li className="text-white text-xs lg:text-[16px]">
