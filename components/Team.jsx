...
const Team = () => {
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView="show"
      viewport={{ once: true, amount: 0.2 }} // ✅ smooth, only animates once
    ...
    >
      ...
      {/* Grid for team cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-8 place-items-center w-full">
