...
const SponsorsComponent = () => {
  ...
  return (
    <>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-3xl w-full gap-8">
          ...
          <div className="flex flex-col items-center justify-center mt-8">
            ...
            <p className="mt-4 text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed bg-gradient-to-r from-[#1ec6fa] via-[#33bbcf] to-[#5ce1e6] bg-clip-text text-transparent px-3 animate-radiant">
              ...
              <span className="font-semibold">Pixcellence</span>, pioneers in
              smart security technology who bring cutting-edge innovation to
              everyday living! 🌟
            </p>
          </div>
        </div>
      ...
      {/* ====== PARTNERS SECTION ====== */}
      <section className="relative flex flex-col items-center justify-center w-full px-4 sm:px-6 py-20 bg-gradient-to-b from-[#0b1121] to-[#020617] text-center">
        <BlurText
          text="Our Partners"
          delay={250}
          animateBy="words"
          direction="top"
          className="text-lg sm:text-2xl md:text-3xl text-[#5ce1e6]/90 font-medium tracking-wide mb-10"
        />
        ...
        <div className="flex flex-col items-center gap-6">
          <img
            ...
            alt="Hack2Skill logo"
            className="w-40 sm:w-56 md:w-72 h-auto object-contain drop-shadow-[0_0_20px_rgba(30,198,250,0.4)] hover:scale-110 transition-all duration-500"
          />

          <p className="text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed bg-gradient-to-r from-[#1ec6fa] via-[#33bbcf] to-[#5ce1e6] bg-clip-text text-transparent">
            Proudly partnering with{" "}
            <span className="font-semibold">Hack2Skill</span> — empowering
            innovation and collaboration in the hackathon ecosystem 🚀
          </p>
        </div>
      </section>
    </>
